...
| [coverage-guard](https://github.com/sametcelikbicak/coverage-guard) | sametcelikbicak | 3 | 自动检测测试覆盖率缺口并生成缺失测试，确保100%覆盖率 | `sametcelikbicak/coverage-guard` |
...
| [flaky-test-detector](https://github.com/sametcelikbicak/flaky-test-detector) | sametcelikbicak | 3 | 检测非确定性测试失败，分类根本原因并应用针对性修复 | `sametcelikbicak/flaky-test-detector` |
...
| [task-decomposer](https://github.com/sametcelikbicak/task-decomposer) | sametcelikbicak | 3 | 将复杂请求分解为结构化、AI友好的任务序列，优化上下文窗口使用 | `sametcelikbicak/task-decomposer` |
